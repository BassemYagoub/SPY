...
public class SendStatements_wrapper : MonoBehaviour
{
	...
	{
		MainLoop.callAppropriateSystemMethod ("SendStatements", "TotalActionInLevel", null);
	}
	...
	{
		MainLoop.callAppropriateSystemMethod ("SendStatements", "ReloadLevelSendStatement", null);
	}
